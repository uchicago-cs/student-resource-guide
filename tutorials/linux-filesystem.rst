...
We think of the file system as a tree.  It is traditional to drawn
with the root of the file system at the top.  We can also think of
...
For larger files, you may want to use the ``more`` command, which
allows you to look at a file one screenfull at a time.
